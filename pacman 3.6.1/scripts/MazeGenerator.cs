...
public class MazeGenerator : TileMap
{
    ...
    public int mazeOriginY; //maybe make this or mazeStartLoc a global variable/static or something
    ...
    private Vector2[,] GenerateAdjList()
    {
        int numFound = 0;


        adjList = new Vector2[nodeList.Count, 4];
    ...
    private void PrintAdjList(Vector2[,] adjList)
    {
